...
- [ ] Локализация интерфейса (English / Русский) + язык сплэш-фраз по языку системы <!-- splash-i18n -->
- [ ] Уведомления о новых версиях — баннер при запуске с кнопкой «Обновить» (скачать и заменить .app)
